...
本目录保存经过核验的论文协议、代码谱系和研读快照。`discussion/` 与外部
`docs_from_claude/` 仍是协作 inbox，不作为稳定事实入口。
...
- `understanding/2026-07-22_claude-dqn-*.md`：Claude 原始综合的稳定快照，证据类别为
  `internal_synthesis`。
- `manifests/2026-07-22_dqn-interpretability-ingestion.tsv`：本批次 source-to-destination
  provenance。
